"""F1·F2 스캔 (읽기 전용): 홈·프로젝트·플러그인·MCP·훅 흐름."""
...
from common import (EXCLUDE_DIRS, KIND_DIRS, LOCAL_NAMES, MD_NAMES, _as_dict, _err,
                    _errors, _expand, _p, _read_json, errors, home, log,
                    parse_frontmatter, read_text)
