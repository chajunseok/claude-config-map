...
![전체 화면: 탐색기·에디터·인스펙터](docs/img/01-files.ko.png)
...
![파일 사이드바에서 web-shop 프로젝트를 선택한 화면](docs/img/01-files.ko.png)
...
![규칙 사이드바: 적용 순서의 CLAUDE.md 체인·섹션 행·충돌 배지](docs/img/02-rules.ko.png)
...
![스킬 사이드바: ON/OFF 스위치와 인스펙터의 4단계 select](docs/img/03-skills.ko.png)
...
![훅 사이드바: 세션 이벤트별 그룹과 중복 매처 경고](docs/img/04-hooks.ko.png)
...
![MCP 사이드바: 출처별 그룹](docs/img/05-mcp.ko.png)
...
![편집 모드: 검증·저장·취소 툴바, 편집 도우미 프롬프트, 팀 공유 경고](docs/img/06-edit.ko.png)
...
![비교 탭: 전역·프로젝트의 같은 제목 섹션 나란히 보기](docs/img/07-compare.ko.png)
